...
function Main()
{
	...
	canvas = document.getElementById('Pong');
  	...
  	createjs.Sound.registerSound("PongEaselJSSource/Final/hit.mp3", "hit");
  	createjs.Sound.registerSound("PongEaselJSSource/Final/playerScore.mp3", "playerScore");
  	createjs.Sound.registerSound("PongEaselJSSource/Final/enemyScore.mp3", "enemyScore");
  	createjs.Sound.registerSound("PongEaselJSSource/Final/wall.mp3", "wall");
	...
	preload.loadFile("../design/images/denis-brogniart.png");
	*/
	
  	bgImg.src = 'PongEaselJSSource/Final/bg.png';
  	bgImg.name = 'bg';
  	bgImg.onload = loadGfx;
  	
  	mainImg.src = 'PongEaselJSSource/Final/main.png';
  	mainImg.name = 'main';
  	mainImg.onload = loadGfx;
	
	startBImg.src = 'PongEaselJSSource/Final/startB.png';
	startBImg.name = 'startB';
	startBImg.onload = loadGfx;
	
	creditsBImg.src = 'PongEaselJSSource/Final/creditsB.png';
	creditsBImg.name = 'creditsB';
	creditsBImg.onload = loadGfx;
	
	creditsViewImg.src = 'PongEaselJSSource/Final/credits.png';
	creditsViewImg.name = 'credits';
	creditsViewImg.onload = loadGfx;
	
	playerImg.src = 'PongEaselJSSource/Final/paddle.png';
	playerImg.name = 'player';
	playerImg.onload = loadGfx;
	
	ballImg.src = 'PongEaselJSSource/Final/ball.png';
	ballImg.name = 'ball';
	ballImg.onload = loadGfx;
	
	cpuImg.src = 'PongEaselJSSource/Final/paddle.png';
	cpuImg.name = 'cpu';
	cpuImg.onload = loadGfx;
	
	winImg.src = 'PongEaselJSSource/Final/win.png';
	winImg.name = 'win';
	winImg.onload = loadGfx;
	
	loseImg.src = 'PongEaselJSSource/Final/lose.png';
	loseImg.name = 'lose';
